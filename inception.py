...
# The first convolution layer size and depth
CONV1_DEEP = 32
CONV1_SIZE = 5

# The second convolution layer size and depth
CONV2_DEEP = 64
CONV2_SIZE = 5
...
def inference(input_tensor, train, regularizer):
    with tf.variable_scope('layer1-conv1'):
        ...
        # Build up convolution layer with all 0 padding
    ...
    with tf.variable_scope('layer6-fc2'):
        ...
        fc2_biases = tf.get_variable('biases', [FC_SIZE], initializer=tf.constant_initializer(0.1))
        logit = tf.nn.relu(tf.matmul(fc1, fc2_weights))
